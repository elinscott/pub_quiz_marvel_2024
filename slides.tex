...
\begin{center}
\Large
5. \input{questions/least_astonishment.tex}
\end{center}
\end{frame}
\begin{frame}
\begin{center}
...
2. ``Prophet Song'', ``The Seven Moons of Maali Almeida'', and ``The Promise'' are all prize-winning whats?
\\
\onslide<2->{\vspace{1em}\textit{\input{manual_slides/bookers.tex}}}
\end{center}
\end{frame}
\begin{frame}
\begin{center}
...
7. ``Die Neue Sammlung'', in Munich, is the largest what in the world? (It translates to ``The New Collection'')
\\
\onslide<2>{\vspace{0.5em}\includegraphics[height=0.6\paperheight]{images/die_neue_sammlung.jpg}}
\\
...
\begin{center}
\Large
1. How many many Pirates of the Caribbean films are there?
\end{center}
\end{frame}
\begin{frame}
\begin{center}
\Large
2. From takeoff to splashdown, how many days long was the Apollo 11 mission?
\end{center}
\end{frame}
\begin{frame}
\begin{center}
\Large
3. In handball, how many players does one team have (excluding subs)?
\end{center}
\end{frame}
\begin{frame}
\begin{center}
\Large
4. How many times will Halley's comet transit earth in the 21st century?
\end{center}
\end{frame}
\begin{frame}
\begin{center}
...
\begin{center}
\Large
7. Osmium is how many times more dense than lead? It is the densest material nautrally found on earth.
\end{center}
\end{frame}
\begin{frame}
\begin{center}
\Large
8. Rounded to the nearest whole number, how many kilograms are there in 1 stone?
\end{center}
\end{frame}
\begin{frame}
\begin{center}
...
\end{frame}
\begin{frame}
\input{puzzles/dynasties_answers.tex}
\end{frame}
\begin{frame}
\input{manual_slides/pros_and_cons_answers.tex}
\end{frame}
\begin{frame}
\begin{center}
\Large
3. \input{puzzles/chess.tex}
\onslide<2->{\vspace{1em}\textit{\input{puzzles/chess_answers.tex}}}
\end{center}
\end{frame}
\begin{frame}
\begin{center}
\Large
4. \input{puzzles/flag_reviews.tex}
\onslide<2->{\vspace{1em}\textit{\input{manual_slides/flags_answers.tex}}}
\end{center}
\end{frame}
\end{document}