...
\begin{center}
\Large
1. In ``A Big Day Out'', why do Wallace and Gromit go to the moon?
\end{center}
\end{frame}
\begin{frame}
\begin{center}
...
\begin{center}
\Large
3. \input{questions/fruit_neutrality.tex}
\end{center}
\end{frame}
\begin{frame}
\begin{center}
\Large
4. This is an emblem of which organisation?
\\
...
\begin{center}
\Large
5. Which 2000 romance saw Johnny Depp star as the love interest of Juliette Binoche?
\end{center}
\end{frame}
\begin{frame}
\begin{center}
\Large
6. What object has a face, a crown, and a lug?
\end{center}
\end{frame}
\begin{frame}
\begin{center}
\Large
7. Which organisation was founded in 1904 by representatives from France, Belgium, Denmark, Spain, Sweden and the Netherlands? In 2015 it was mired in a corruption scandal.
\end{center}
\end{frame}
\begin{frame}
...
2. The earliest evidence of skiing comes from which modern-day country?
\\
\onslide<2>{\vspace{0.5em}\includegraphics[height=0.6\paperheight]{images/skiing.jpg}}
\\
...
\\
\onslide<2->{\vspace{1em}\textit{The Red Cross -- the ``Red Crystal'' is an alternative emblem used when both the cross and cresent are religiously insensitive}}
\end{center}
\end{frame}
\begin{frame}
\begin{center}
...
\begin{center}
\Large
3. In tennis, what feat was most recently achieved by Steffi Graf in 1988? (Here I am excluding wheelchair disciplines; it has been achieved three times by Diede de Groot since 2021.)
\end{center}
\end{frame}
\begin{frame}
\begin{center}
...
\begin{center}
\Large
6. In the context of philosophy, what is ``Materialism''
\end{center}
\end{frame}
\begin{frame}
\begin{center}
...
\begin{center}
\Large
1. Rounded to the nearest whole number, how many kilograms are there in 1 stone?
\end{center}
\end{frame}
\begin{frame}
\begin{center}
\Large
2. How many times will Halley's comet transit earth in the 21st century?
\end{center}
\end{frame}
\begin{frame}
\begin{center}
...
\begin{center}
\Large
4. How many eyelids (per eye) does a polar bear have?
\end{center}
\end{frame}
\begin{frame}
\begin{center}
